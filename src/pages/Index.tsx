      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Find exact matches or alternatives for hex colors in your design
            system
          </p>
        </div>
      </header>
            ...
            <TabsContent value="matcher">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Enter a hex color to find exact matches within the design
                  system or discover similar alternatives
                </p>
                <div className="mt-2 bg-blue-50 p-3 rounded-md border border-blue-100">
                  <p className="text-sm text-blue-700">
                    <strong>New!</strong> Copy any hex color from another
                    application, and it will be automatically detected and
                    analyzed when you return to this page.
                  </p>
                </div>
              </div>
